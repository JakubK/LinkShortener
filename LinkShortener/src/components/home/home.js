  ...
  render()
  {
    ...
    <main className="home">
      <div className="home-container">
        <input name="longLink" className="home-input" placeholder="Paste your link here..." type="text"/>
        <input name="linkPassword" className="home-input" placeholder="Set password (optional)" type="password"/>
        <button onClick={() => this.handleSubmit} className="btn-shorten">Shorten</button>
